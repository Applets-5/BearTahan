...
| BearAI | BEARAI | AI-powered parent consultation — insight card, chat interface, Gemini API integration, context payload assembly |
...
- Insight is generated by calling Gemini API with child Firestore data as context (see BT-05 Section 13)
...
**⚠️ Risk:** Gemini API key must be provisioned and Cloud Function wrapper must be deployed before this story can be completed. Dev 2 resolves open item O8 on Sprint 3 Day 1.
...
**Dependencies:** BEAR-56 (BearAI tab and insight card must exist), Gemini API Cloud Function from O8
