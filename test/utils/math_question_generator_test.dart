...
void main() {
  group('MathGenerationRule.fromMap', () {
    ...
    test('parses subtraction rule from "operationType" and numeric strings', () {
      final rule = MathGenerationRule.fromMap({
  ...
  group('MathQuestionGenerator', () {
    ...
    test('boundary: subtraction where minA == minB == maxA == maxB gives zero', () {
      const rule = MathGenerationRule(
        operation: MathOperation.subtraction,
        minA: 5,
        maxA: 5,
    ...
    test('options always contain exactly 4 distinct, non-negative integers', () {
      const rules = [
        MathGenerationRule(
          operation: MathOperation.addition,
          minA: 1,
    ...
    test('toQuestion maps the correct answer to its index among the options', () {
      const rule = MathGenerationRule(
        operation: MathOperation.addition,
        minA: 1,
        maxA: 10,
