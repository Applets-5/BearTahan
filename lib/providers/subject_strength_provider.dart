...
final subjectStrengthProvider =
    StreamProvider.family<Map<String, SubjectWeaknessInfo>, String>((
      ref,
      childId,
    ) {
          ...
          return attemptsAsync.when(
            data: (attempts) {
              ...
              for (final subject in subjects) {
                final subjectAttempts = attempts
                ...
                final avgTime = subjectAttempts.isNotEmpty
                    ? totalTime ~/ subjectAttempts.length
                    : 0;
                ...
                final double strengthScore =
                    (progressScore + accuracy + timeScore) / 3.0;
